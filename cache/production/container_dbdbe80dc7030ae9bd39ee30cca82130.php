...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000650123f0000000071945b18(
...
class phpbbtemplatetwiglexer_000000000650123f0000000071945b18 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59ebd2dae8615841987081 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59ebd2dae8622358786934 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59ebd2dae85e2503940452 = array(
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, 'set_environment', array('env' => $env), $this->initializer59ebd2dae8622358786934);

        return $this->valueHolder59ebd2dae8615841987081->set_environment($env);
    }
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59ebd2dae8622358786934);

        return $this->valueHolder59ebd2dae8615841987081->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59ebd2dae8622358786934);

        return $this->valueHolder59ebd2dae8615841987081->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59ebd2dae8622358786934 = $initializer;
    }
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, '__get', array('name' => $name), $this->initializer59ebd2dae8622358786934);

        if (isset(self::$publicProperties59ebd2dae85e2503940452[$name])) {
            return $this->valueHolder59ebd2dae8615841987081->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59ebd2dae8615841987081;
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59ebd2dae8622358786934);
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, '__isset', array('name' => $name), $this->initializer59ebd2dae8622358786934);
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, '__unset', array('name' => $name), $this->initializer59ebd2dae8622358786934);
    ...
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, '__clone', array(), $this->initializer59ebd2dae8622358786934);

        $this->valueHolder59ebd2dae8615841987081 = clone $this->valueHolder59ebd2dae8615841987081;
    }

    public function __sleep()
    {
        $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, '__sleep', array(), $this->initializer59ebd2dae8622358786934);

        return array('valueHolder59ebd2dae8615841987081');
    }
    ...
    {
        return $this->initializer59ebd2dae8622358786934;
    }
    ...
    {
        return $this->initializer59ebd2dae8622358786934 && $this->initializer59ebd2dae8622358786934->__invoke($this->valueHolder59ebd2dae8615841987081, $this, 'initializeProxy', array(), $this->initializer59ebd2dae8622358786934);
    }
    ...
    {
        return null !== $this->valueHolder59ebd2dae8615841987081;
    }
    ...
    {
        return $this->valueHolder59ebd2dae8615841987081;
    }
