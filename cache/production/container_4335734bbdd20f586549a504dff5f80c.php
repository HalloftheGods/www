...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002ba5aeb0000000001ea0b1ca(
...
class phpbbtemplatetwiglexer_000000002ba5aeb0000000001ea0b1ca extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59ebd2750cb62209004515 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59ebd2750cb6f626761527 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59ebd2750cb34725145034 = array(
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, 'set_environment', array('env' => $env), $this->initializer59ebd2750cb6f626761527);

        return $this->valueHolder59ebd2750cb62209004515->set_environment($env);
    }
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59ebd2750cb6f626761527);

        return $this->valueHolder59ebd2750cb62209004515->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59ebd2750cb6f626761527);

        return $this->valueHolder59ebd2750cb62209004515->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59ebd2750cb6f626761527 = $initializer;
    }
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, '__get', array('name' => $name), $this->initializer59ebd2750cb6f626761527);

        if (isset(self::$publicProperties59ebd2750cb34725145034[$name])) {
            return $this->valueHolder59ebd2750cb62209004515->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59ebd2750cb62209004515;
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59ebd2750cb6f626761527);
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, '__isset', array('name' => $name), $this->initializer59ebd2750cb6f626761527);
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, '__unset', array('name' => $name), $this->initializer59ebd2750cb6f626761527);
    ...
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, '__clone', array(), $this->initializer59ebd2750cb6f626761527);

        $this->valueHolder59ebd2750cb62209004515 = clone $this->valueHolder59ebd2750cb62209004515;
    }

    public function __sleep()
    {
        $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, '__sleep', array(), $this->initializer59ebd2750cb6f626761527);

        return array('valueHolder59ebd2750cb62209004515');
    }
    ...
    {
        return $this->initializer59ebd2750cb6f626761527;
    }
    ...
    {
        return $this->initializer59ebd2750cb6f626761527 && $this->initializer59ebd2750cb6f626761527->__invoke($this->valueHolder59ebd2750cb62209004515, $this, 'initializeProxy', array(), $this->initializer59ebd2750cb6f626761527);
    }
    ...
    {
        return null !== $this->valueHolder59ebd2750cb62209004515;
    }
    ...
    {
        return $this->valueHolder59ebd2750cb62209004515;
    }
